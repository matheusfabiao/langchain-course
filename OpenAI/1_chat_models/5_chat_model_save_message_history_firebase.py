...
# Inicializar o modelo de chat da OpenAI
print('Inicializando o modelo de chat da OpenAI...')
model = ChatOpenAI(model='gpt-4o', temperature=0)

print(
    "Comece a interação com o modelo de chat da OpenAI! Digite 'exit' para sair."
)
